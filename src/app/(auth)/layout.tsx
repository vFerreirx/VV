...
export default function AuthLayout({
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-muted/30 pt-[max(1rem,env(safe-area-inset-top))] pb-[max(1rem,env(safe-area-inset-bottom))] pl-[max(1rem,env(safe-area-inset-left))] pr-[max(1rem,env(safe-area-inset-right))]">
