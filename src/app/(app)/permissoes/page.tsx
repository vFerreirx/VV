    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1 text-sm">
          Ligue ou desligue o acesso de cada cargo às áreas do sistema. O
          Administrador e o Gerente ficam fixos. Dentro de cada área, quem cria
          e edita segue a regra de cada ação.
        </p>
      </div>
